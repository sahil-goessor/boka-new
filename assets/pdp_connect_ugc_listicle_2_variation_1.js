...
window.__WWAI__.WWAI_PRODUCT_GROUP_CONFIG = {
  "refresh_mint_toothpaste_pdp_C9pxRm": {
    "defaults": {
      "pricingConfig": {
        "discountPercent": 0,
  ...
  "boka_static_listicle_products_fnHR7Y": {
    ...
    "brightboost-whitening-kit": {
      "pricingConfig": null,
      "uxConfig": null,
      "flowConfig": null,
      "variantDispatchConfig": {
        "defaultProduct": "brightboost-whitening-kit",
        "defaultVariantOption1": "Ela Mint",
        "defaultVariantOption2": "White",
        "defaultVariantOption3": null,
        "allProducts": "brightboost-whitening-kit",
        "allOptions": {
          "option1": "Ela Mint | Lemon Lavender | Charcoal Yuzu Mint | Coco Ginger | Cinna Mint | Refresh Mint Whitening | Cucumber Mint",
          "option2": "White | Blue | Mint | Pink",
          "option3": ""
        }
      }
    },
  ...
  "boka_static_listicle_products_fnHR7Y": {
    "brightboost-whitening-kit": {
      "brightboost-whitening-kit": {
        ...
        "Charcoal Yuzu Mint | White": {
          "customMediaLabel": null,
          "redirectToMediaIndex": null,
          "customLabelText": {}
        },
        "Charcoal Yuzu Mint | Blue": {
          "customMediaLabel": null,
          "redirectToMediaIndex": null,
          "customLabelText": {}
        },
        "Charcoal Yuzu Mint | Mint": {
          "customMediaLabel": null,
          "redirectToMediaIndex": null,
          "customLabelText": {}
        },
        "Charcoal Yuzu Mint | Pink": {
          "customMediaLabel": null,
          "redirectToMediaIndex": null,
          "customLabelText": {}
        },
        ...
        "Refresh Mint Whitening | White": {
          "customMediaLabel": null,
          "redirectToMediaIndex": null,
          "customLabelText": {}
        },
        "Refresh Mint Whitening | Blue": {
          "customMediaLabel": null,
          "redirectToMediaIndex": null,
          "customLabelText": {}
        },
        "Refresh Mint Whitening | Mint": {
          "customMediaLabel": null,
          "redirectToMediaIndex": null,
          "customLabelText": {}
        },
        "Refresh Mint Whitening | Pink": {
          "customMediaLabel": null,
          "redirectToMediaIndex": null,
          "customLabelText": {}
        },
